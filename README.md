...
Community 免费版无需登录、联网或授权文件。已经公开的**匠心矢量、智能矢量、轻量矢量和精确重建**继续属于 Community / 开放核心；未来 Pro 的“生产级矢量工作流”只指批量、自动化、项目管理、商业交付、新的私有增强、稳定签名安装包和专业支持，不能把同一份 MIT 能力重新包装成独占收费功能。
