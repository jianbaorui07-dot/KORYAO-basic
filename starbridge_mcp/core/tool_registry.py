...
CAPABILITIES: tuple[ToolCapability, ...] = (
    ...
    ToolCapability(
        ...
        maturity="prototype",
        risk_level="safe_read_only",
        description="Plan a ComfyUI txt2img workflow from a natural-language goal without generating or submitting a job.",
    ...
    ToolCapability(
        ...
        requires_local_software=True,
        source_projects=("IO-AtelierTech/comfyui-mcp", "artokun/comfyui-mcp"),
        next_step="Extend the agent workflow to ControlNet, LoRA, img2img, inpaint, and upscale after txt2img lifecycle is stable.",
    ),
    ToolCapability(
