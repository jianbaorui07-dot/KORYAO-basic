...
CAPABILITIES: tuple[ToolCapability, ...] = (
    ...
    ToolCapability(
        ...
        maturity="implemented",
        risk_level="safe_read_only",
        description="List safe cross-bridge StarBridge recipes without launching desktop software.",
    ...
    ToolCapability(
        ...
        maturity="implemented",
        risk_level="safe_read_only",
        description="Return a dry-run action plan, quality gates, and evidence requirements for one StarBridge recipe.",
    ...
    ToolCapability(
        ...
        maturity="implemented",
        risk_level="safe_read_only",
        description="Preview a standardized EvidenceManifest for one StarBridge recipe, including quality gates and asset manifest entries.",
